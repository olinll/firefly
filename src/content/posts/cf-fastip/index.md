...
优选前：
![优选前 ITDOG IP数量](./images/0002.webp)
优选后：
![优选后 ITDOG IP数量](./images/0001.webp)
...
![配置Worker路由](./images/0004.webp)

最后写一条 DNS 解析到上面配置的优选域名即可。

![配置域名优选](./images/0005.webp)
...
![创建CloudFlare Worker 并修改代码](./images/0006.webp)
...
![外域域名CNAME到cf cdn域名去](./images/0008.webp)
